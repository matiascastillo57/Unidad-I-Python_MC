...
INSTALLED_APPS = [
    ...
    # Apps del proyecto
    'monitoring',  # Tu app principal (devices/dispositivos)
    'usuarios',    # App de perfiles
...
if ENGINE == "sqlite":
    ...
    # MySQL (si decides usarlo después)
    DATABASES = {
        "default": {
...
# En caso de usar Mailtrap o SMTP real:
...
# DEFAULT_FROM_EMAIL = 'EcoEnergy <noreply@ecoenergy.com>'